  ...
  try {
    ...
    if (existingTeacher.rows.length === 0) {
      ...
      const studentsData = [
        ...
        { name: 'Chalukya Nayaka B K', email: 'chalukyanayakbk2@gmail.com', quota: 'PGCET', stream: 'MTech CS', joiningDate: '18/11/2025', officialEmail: 'pgcet2501064@reva.edu.in', mobile: '9591225555', pgcetNum: '2501064', gender: 'Male' },
