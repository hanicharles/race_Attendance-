...
function getDb() {
  ...
  try {
    ...
    if (isCloudflare && !process.env.TURSO_CONNECTION_URL) {
      console.warn(
        "[SQLite Server] Running in Cloudflare but TURSO_CONNECTION_URL is not set. Database client mocked.",
      );
      dbInstance = {
        execute: async () => {
          throw new Error(
            "Database not configured. Since you are deploying to a serverless platform (like Cloudflare Pages), a local SQLite file database cannot be used. Please set up a hosted SQLite database (such as Turso) and configure the TURSO_CONNECTION_URL and TURSO_AUTH_TOKEN environment variables in your Cloudflare Pages dashboard settings (under Settings -> Environment Variables). See the cloudflare_deployment.md file in your project for step-by-step instructions.",
          );
        },
      };
    } else {
    ...
    if (
      ...
      (message.includes("URL_SCHEME_NOT_SUPPORTED") || message.includes("only supports"))
    ) {
      message =
        "Database not configured. Since you are deploying to a serverless platform (like Cloudflare Pages), a local SQLite file database cannot be used. Please set up a hosted SQLite database (such as Turso) and configure the TURSO_CONNECTION_URL and TURSO_AUTH_TOKEN environment variables in your Cloudflare Pages dashboard settings (under Settings -> Environment Variables). See the cloudflare_deployment.md file in your project for step-by-step instructions.";
    }
  ...
  try {
    ...
    if (existingTeacher.rows.length === 0) {
      ...
      const studentsData = [
        {
          ...
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2501001@reva.edu.in",
          mobile: "9141428452",
          pgcetNum: "2501001",
          gender: "Male",
        },
        {
          ...
          stream: "MTech AI",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2501009@reva.edu.in",
          mobile: "9945005114",
          pgcetNum: "2501009",
          gender: "Male",
        },
        {
          ...
          stream: "MTech CS",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2500971@reva.edu.in",
          mobile: "8904488242",
          pgcetNum: "2500971",
          gender: "Male",
        },
        {
          ...
          officialEmail: "pgcet2500946@reva.edu.in",
          mobile: "9845148754",
          pgcetNum: "2500946",
          gender: "Female",
        },
        {
          ...
          officialEmail: "pgcet2500999@reva.edu.in",
          mobile: "8073249441",
          pgcetNum: "2500999",
          gender: "Female",
        },
        {
          ...
          stream: "MTech AI",
          joiningDate: "29/10/2025",
          officialEmail: "pgcet2500959@reva.edu.in",
          mobile: "8147931652",
          pgcetNum: "2500959",
          gender: "Female",
        },
        {
          ...
          stream: "MTech AI",
          joiningDate: "29/10/2025",
          officialEmail: "pgcet2500996@reva.edu.in",
          mobile: "7676428044",
          pgcetNum: "2500996",
          gender: "Female",
        },
        {
          ...
          email: "chalukyanayakbk2@gmail.com",
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2501064@reva.edu.in",
          mobile: "9591225555",
          pgcetNum: "2501064",
          gender: "Male",
        },
        {
          name: "Shilpa J",
          email: "shilpaj18204@gmail.com",
          quota: "PGCET",
          stream: "MTech AI",
          joiningDate: "29/10/2025",
          officialEmail: "pgcet2500992@reva.edu.in",
          mobile: "7760874405",
          pgcetNum: "2500992",
          gender: "Female",
        },
        {
          name: "Janhvi Jeevan Revankar",
          email: "revankarjanhvi@gmail.com",
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "29/10/2025",
          officialEmail: "pgcet2501013@reva.edu.in",
          mobile: "7483790438",
          pgcetNum: "2501013",
          gender: "Female",
        },
        {
          name: "Kondamadugula venkateshwara reddy",
          email: "kvenkatreddy1414@gmail.com",
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "18//11/2025",
          officialEmail: "pgcet2501089@reva.edu.in",
          mobile: "7975545680",
          pgcetNum: "2501089",
          gender: "Male",
        },
        {
          ...
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "09/10/2025",
          officialEmail: "pgcet2500787@reva.edu.in",
          mobile: "8105201899",
          pgcetNum: "2500787",
          gender: "Female",
        },
        {
          ...
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "30/10/2025",
          officialEmail: "pgcet2501072@reva.edu.in",
          mobile: "910618926",
          pgcetNum: "2501072",
          gender: "Female",
        },
        {
          ...
          stream: "MTech CS",
          joiningDate: "09/10/2025",
          officialEmail: "pgcet2500797@reva.edu.in",
          mobile: "9535463787",
          pgcetNum: "2500797",
          gender: "Female",
        },
        {
          ...
          stream: "MTech AI",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2500758@reva.edu.in",
          mobile: "9741150810",
          pgcetNum: "2500758",
          gender: "Female",
        },
        {
          ...
          stream: "MTech AI",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2501015@reva.edu.in",
          mobile: "6361721470",
          pgcetNum: "",
          gender: "Female",
        },
        {
          ...
          stream: "MTech AI",
          joiningDate: "18/11/2025",
          officialEmail: "Meenu.AIFT25@race.reva.edu.in",
          mobile: "9008557126",
          pgcetNum: "580",
          gender: "Female",
        },
        {
          ...
          stream: "M.Sc CS",
          joiningDate: "18/11/2025",
          officialEmail: "Kaarthikeyen.CSFT25@race.reva.edu.in",
          mobile: "7200845465",
          pgcetNum: "937",
          gender: "Male",
        },
        {
          ...
          stream: "M.Sc CS",
          joiningDate: "18/11/2025",
          officialEmail: "Shaan.CSFT25@race.reva.edu.in",
          mobile: "8431397516",
          pgcetNum: "1057",
          gender: "Male",
        },
        {
          name: "Mevada Vinit",
          email: "vinitmevada0253v@gmail.com",
          quota: "MQ",
          stream: "MTech CS",
          joiningDate: "18/11/2025",
          officialEmail: "Mevada.CSFT25@race.reva.edu.in",
          mobile: "9099442190",
          pgcetNum: "1121",
          gender: "Male",
        },
        {
          name: "Dhanusha G",
          email: "dhanusha.govind99@gmaila.com",
          quota: "PGCET",
          stream: "MTech AI",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2500907@race.reva.edu.in",
          mobile: "9731326208",
          pgcetNum: "2500907",
          gender: "Female",
        },
        {
          ...
          stream: "MSc CS",
          joiningDate: "18/11/2025",
          officialEmail: "dattaguru.csft25@race.reva.edu.in",
          mobile: "9004230088",
          pgcetNum: "1112",
          gender: "Male",
        },
        {
          ...
          stream: "MTech AI",
          joiningDate: "18/11/2025",
          officialEmail: "pgcet2501106@reva.edu.in",
          mobile: "7338679989",
          pgcetNum: "2501106",
          gender: "Male",
        },
        {
          ...
          quota: "PGCET",
          stream: "MTech AI",
          joiningDate: "3/12/2025",
          officialEmail: "pgcet2500791@reva.edu.in",
          mobile: "9481232907",
          pgcetNum: "",
          gender: "Female",
        },
        {
          ...
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "4/12/2025",
          officialEmail: "pgcet2500947@reva.edu.in",
          mobile: "7760199226",
          pgcetNum: "",
          gender: "Male",
        },
        {
          name: "Ayesha",
          email: "pgcet2501117@reva.edu.in",
          quota: "PGCET",
          stream: "MTech CS",
          joiningDate: "",
          officialEmail: "pgcet2501117@reva.edu.in",
          mobile: "",
          pgcetNum: "",
          gender: "Female",
        },
      ...
      const attendanceSeeds: Record<string, string> = {
        "Sai krishna k m":
          "111111110111111N10101010011111110111110111111110111111111111011011111111N11N10111101N1111111111111111111111111111111111111110",
        "Shashwath K S":
          "111111111111111N11111111111111011111111111011111111110111111111111011111N11N11111011N1111111011111111011110011111110100100001111",
        "Sewana M":
          "111111111111111N11111111111111110111111110011111111111111111110111111111N11N11111111N0111115111110151111111101111111011111111111",
        "Ambika Yallal":
          "111111110111111N11111111101011111111110111111110011111111111111111111111N11N11111111N111111000011111111111111111111011111111111111",
        "Aishwarya L Pujeri":
          "111111111111111N11111111111011111111111111111100111111111111111111111111N11N11111111N111111110111111111101111111111011111111111111",
        "Alina Shibu":
          "111111110111111N11111111111111110111111111111111111101111111111111011111N11N11111111N0111111111111511111111011111111111111101111",
        "Bhagyashree C Patil":
          "111111110110111N11111111101111110111111111111111111101111111011101010111N11N11111111N0111010101111101111110101011111111111111111",
        "Chalukya Nayaka B K":
          "111111111111111N11111111111111101111101111111111011111111111011111101111N11N11111111N1111111111100111111110111111111111111111111",
        "Shilpa J":
          "111111111111111N11111111111011101111111011501111111111011111111011011101N11N11111111N1111111000111000111110111101111111111111111",
        "Janhvi Jeevan Revankar":
          "111111111111111N11111111101111111111111111111111111111111110111111110111N11N11010111N1111115111111111111111111111111111111111111",
        "Kondamadugula venkateshwara reddy":
          "111000010001000N000000000NNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN",
        "Sreediya S":
          "111111111111111N11111111111011111111111111111111110111111101111111111111N11N11111111N01111110111011111111111111111111111511111",
        "Nithya T M":
          "111111111111111N11111111101111110011111111111111111111111111111111101111N11N11111111N0111111011151111111110111011111111111111111",
        "Lakshmi Shivani K":
          "110111110111111N11111111101111015011111111111151111111101111111511001111N11N11111111N1111111011111111111100111011110111111111111",
        "Jothika B":
          "111101111111000N00000000010000100001010000100101000111000110011010101001N00N01010000N1000111111111111111111111111111111111111111",
        "Sneha S":
          "000000100011111N11111111101111111111110111111111111111111111111011111111N11N01011101N111111011115110111111011111111111011111111",
        "B Meenu":
          "111111110111111N11111111111111111111110111111111111111111111111111011111N11N11111111N111111115111111111111111111111101111111111",
        "Kaarthikeyen G":
          "111111111111111N11111111111111111101101111111111111100511110100111111111N11N11111111N1111111111111111111111100111111111111111111",
        "Shaan Abraham":
          "111111111111111N11111111111111111111011011111111111111111111111111111111N11N11111111N0111111115111111111111111111111111111111111",
        "Mevada Vinit":
          "111111111111111N11111111111111111111110011111111111110111101001011111111N11N11111111N111111111111111111111111111111111111111111",
        "Dhanusha G":
          "100001111111111N11111111111011101111111111111111111101111110111011111111N11N11111101N111111111111111111111011111111111111111111",
        "Dattaguru Chettiar":
          "111111111111111N11111111101111111111111111111111111111111111111110111111N11N11111111N111111111111111111111111111111111111111111",
        "Avish T S":
          "101011111111111N11111111101111111111110111111111110111111111011111101111N11N11111111N11111101111111110111111110111010111101101111011",
        "Veda Shivayogi Ramagondanahalli":
          "NNNNNNNNN111111N11111111101111111111110011111111111111111111111111110111N11N11111111N1111111100111101111111111111111111111111111",
        "Rajendra Rathod":
          "NNNNNNNNNNNN111N11111111101111111011110510011111111101111111110110101110N11N11111111N011111501115101151111010110110000111111101110000111111",
        Ayesha:
          "NNNNNNNNNNNNNNNNNNNNNNNNN10010011100111111111115111111111101111011011111N11N01011101N11111151111110010111100011101111111111111011111111111",
      };

      // Map name -> id for student records we just inserted
      const studentMap: Record<string, string> = {};
      const allStudentsRes = await db.execute(
        "SELECT id, name FROM students WHERE class_id = '" + classId + "'",
      );
...
export async function handleDbQuery(query: any = {}) {
  ...
  try {
    ...
    if (action === "select") {
      ...
      if (table === "students" && select && select.includes("classes")) {
        ...
        if (filters) {
          for (const f of filters) {
            const prefix =
              f.col === "id" || f.col === "user_id" || f.col === "class_id" ? "s." : "";
            if (f.type === "eq") {
      ...
      if (table === "holidays" && user) {
        ...
        if (role === "student") {
          ...
          const tIds = teacherRes.rows.map((r: { teacher_id: unknown }) => r.teacher_id as string);
          if (tIds.length > 0) {
    ...
    return {
      data: null,
      error: { message: e.message || "Database execution error", code: e.code },
    };
  }
}
